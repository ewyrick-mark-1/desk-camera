...
- 1. MVP - get a USB webcam ziptied to a desk lamp and establish a local web UI for monitoring and easy acces to the video feed. <-- We are here
- 2. Change from a basic manual camera system to an automated ring buffer system. Update UI with cutting and saving functionality.
